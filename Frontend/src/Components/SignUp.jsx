...
const SignUp = () => {
  ...
  const onSubmitHandler = async (e) =>{
    ...
    // console.log(info);
    try{
      const res = await axios.post('https://chat-application-with-redux.onrender.com/api/v1/user/register',info,{headers:{"Content-Type":'application/json'}, withCredentials:true})
      if(res.data.success){
