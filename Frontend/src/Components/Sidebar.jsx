...
const Sidebar = () => {
  ...
  const logOutHandler = async(e) =>{
    try{
      const res = await axios.get('https://chat-application-with-redux.onrender.com/api/v1/user/logout',{headers:{"Content-Type":'application/json'},withCredentials:true})
      if(res.data.success){
