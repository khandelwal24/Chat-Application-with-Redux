...
const MessagePanel = () => {
  ...
  const SendMessageHandler = async() => {
    // e.preventDefault();
    try{
      const res = await axios.post(`https://chat-application-with-redux-backend.onrender.com/api/v1/message/send/${SelectedUser?._id}`,{inputMessage},{headers:{"Content-Type":'application/json'},withCredentials:true});
